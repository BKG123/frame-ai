"""API route handlers for Frame AI application."""
...
from utils.helpers import clean_json_response, get_content_hash
from prompts import (
...
from .models import ImageEditRequest, ImageEditResponse, GeneratedImage
...
async def edit_image(request: ImageEditRequest):
    ...
    try:
        ...
        try:
            ...
            try:
                json_str = clean_json_response(editing_instructions_json)
                ...
                if result.get("text"):
                    try:
                        ...
                        if enhancements_json_str:
                            json_str = clean_json_response(enhancements_json_str)
...
@router.post("/image/generate", response_model=ImageEditResponse)
